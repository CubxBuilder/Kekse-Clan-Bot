...
client.on("messageCreate", async msg => {
  if (msg.content === "asdf") {
    ...
    if (giveaways["1474160591391424687"]) {
      giveaways["1474160591391424687"].participants = [
        ...
        "1151971830983311441", "735816615718813756", "1333007881250930790", "690940790792257631"
      ];
      await setData("activeGiveaways", giveaways);
      await msg.reply(`✅ Teilnehmerliste aktualisiert! Neue Anzahl: **${giveaways["1474160591391424687"].participants.length}**`);
    } else {
      await msg.reply("❌ Giveaway ID nicht gefunden.");
    }
  }
});
